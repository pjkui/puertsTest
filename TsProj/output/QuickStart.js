...
const UI_testFairyTS_1 = require("./UI_testFairyTS");
//静态函数
...
//in out 参数
let p1 = puerts_1.$ref(1);
let p2 = puerts_1.$ref(10);
let ret = obj.InOutArgFunc(100, p1, p2);
console.log('ret=' + ret + ', out=' + puerts_1.$unref(p1) + ', ref=' + puerts_1.$unref(p2));
//泛型
//先通过$generic实例化泛型参数
let List = puerts_1.$generic(csharp_1.System.Collections.Generic.List$1, csharp_1.System.Int32); //$generic调用性能不会太好，同样泛型参数建议整个工程，至少一个文件内只做一次
let Dictionary = puerts_1.$generic(csharp_1.System.Collections.Generic.Dictionary$2, csharp_1.System.String, List);
let lst = new List();
lst.Add(1);
lst.Add(0);
lst.Add(2);
...
go.AddComponent(puerts_1.$typeof(csharp_1.UnityEngine.ParticleSystem));
...
obj.Extension2(obj1);
csharp_1.UnityEngine.Debug.Log("Init fairy");
var item = UI_testFairyTS_1.UI_testFairyTS.CreateInstance();
csharp_1.FairyGUI.GRoot.inst.AddChild(item);
item.MakeFullScreen();
item.visible = true;
